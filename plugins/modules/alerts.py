...
DOCUMENTATION = r'''
module: alerts
short_description: 'This module allows you to work with networker Alerts'
description: 'This operation can be used to list the outstanding alert messages. The query parameters can be used to filter the response.'
version_added: '2.0.0'
options:
  state:
    type: str
